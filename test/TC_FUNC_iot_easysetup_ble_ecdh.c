...
static int _tc_ble_ecdh_setup(void **state)
{
    iot_error_t err;
    UNUSED(state);
...
static int _tc_ble_ecdh_teardown(void **state)
{
    iot_error_t err;
    UNUSED(state);
    tc_mock_ble_set_get_certificate_use_wrap(0);
...
int TEST_FUNC_iot_easysetup_ble_ecdh(void)
{
    const struct CMUnitTest tests[] = {
        cmocka_unit_test_setup_teardown(TC_iot_easysetup_ble_ecdh_init_success, _tc_ble_ecdh_setup,
                                        _tc_ble_ecdh_teardown),
        cmocka_unit_test_setup_teardown(TC_iot_easysetup_ble_ecdh_init_malloc_failure_context, _tc_ble_ecdh_setup,
                                        _tc_ble_ecdh_teardown),
        cmocka_unit_test_setup_teardown(TC_iot_easysetup_ble_ecdh_init_pk_init_malloc_failure, _tc_ble_ecdh_setup,
                                        _tc_ble_ecdh_teardown),
        cmocka_unit_test_setup_teardown(TC_iot_easysetup_ble_ecdh_teardown_null, _tc_ble_ecdh_setup,
                                        _tc_ble_ecdh_teardown),
        cmocka_unit_test_setup_teardown(TC_iot_easysetup_ble_ecdh_teardown_success, _tc_ble_ecdh_setup,
                                        _tc_ble_ecdh_teardown),
        cmocka_unit_test_setup_teardown(TC_iot_easysetup_ble_ecdh_compute_shared_signature_success, _tc_ble_ecdh_setup,
                                        _tc_ble_ecdh_teardown),
        cmocka_unit_test_setup_teardown(TC_iot_easysetup_ble_ecdh_compute_shared_signature_no_device_cert,
                                        _tc_ble_ecdh_setup, _tc_ble_ecdh_teardown),
        ...
        cmocka_unit_test_setup_teardown(TC_iot_easysetup_ble_ecdh_compute_shared_signature_subca_fail,
                                        _tc_ble_ecdh_setup, _tc_ble_ecdh_teardown),
        cmocka_unit_test_setup_teardown(TC_iot_easysetup_ble_ecdh_compute_with_malloc_failure_3, _tc_ble_ecdh_setup,
                                        _tc_ble_ecdh_teardown),
        cmocka_unit_test_setup_teardown(TC_iot_easysetup_ble_ecdh_compute_with_malloc_failure_5, _tc_ble_ecdh_setup,
                                        _tc_ble_ecdh_teardown),
    };
