...
static int _tc_ble_msg_setup(void **state)
{
    UNUSED(state);
...
static int _tc_ble_msg_teardown(void **state)
{
    UNUSED(state);
    es_reset_transferdata();
    tc_mock_ble_reset();
...
void TC_es_msg_assemble_null_buf(void **state)
{
    bool rc;
    UNUSED(state);
...
void TC_es_msg_assemble_zero_len(void **state)
{
    uint8_t buf[1] = {0};
    bool rc;
    UNUSED(state);
...
void TC_es_msg_assemble_segment_larger_than_total(void **state)
{
    uint8_t buf[32];
    bool rc;
    UNUSED(state);
...
void TC_es_msg_assemble_idle_with_non_zero_opcode(void **state)
{
    uint8_t buf[32];
    bool rc;
    UNUSED(state);
...
void TC_es_msg_assemble_single_shot_success(void **state)
{
    uint8_t buf[32];
    bool rc;
    UNUSED(state);
...
void TC_es_msg_assemble_fragmented_success(void **state)
{
    uint8_t buf[512];
    UNUSED(state);
...
void TC_es_msg_assemble_assemble_mismatch_opcode(void **state)
{
    uint8_t buf[512];
    UNUSED(state);
...
void TC_es_msg_assemble_assemble_overflow(void **state)
{
    uint8_t buf[512];
    UNUSED(state);
...
void TC_es_msg_assemble_duplicated_cmd_num(void **state)
{
    uint8_t buf[32];
    UNUSED(state);
...
void TC_es_msg_assemble_data_continued(void **state)
{
    uint8_t buf[512];
    UNUSED(state);
...
void TC_es_msg_assemble_transaction_id_regression(void **state)
{
    uint8_t buf[32];
    UNUSED(state);
...
void TC_es_msg_assemble_zero_total_size(void **state)
{
...
void TC_es_msg_assemble_disassemble_state_reset(void **state)
{
    uint8_t buf[256];
    UNUSED(state);
...
void TC_es_msg_assemble_data_alloc_failure(void **state)
{
    uint8_t buf[32];
    bool rc;
    UNUSED(state);
...
void TC_es_msg_assemble_payload_alloc_failure(void **state)
{
    uint8_t buf[32];
    bool rc;
    UNUSED(state);
...
void TC_es_msg_disassemble_null_buf(void **state)
{
    iot_error_t err;
    UNUSED(state);
...
void TC_es_msg_disassemble_zero_len(void **state)
{
    iot_error_t err;
    uint8_t payload[4] = {0};
    UNUSED(state);
...
void TC_es_msg_disassemble_deprecated_cmd(void **state)
{
    iot_error_t err;
    uint8_t payload[8] = {0};
    UNUSED(state);
...
void TC_es_msg_disassemble_malloc_failure(void **state)
{
    iot_error_t err;
...
void TC_es_msg_disassemble_success_single_shot(void **state)
{
    iot_error_t err;
...
void TC_es_msg_disassemble_success_fragmented(void **state)
{
    iot_error_t err;
    uint8_t payload[800];
    uint8_t buf[32];
...
void TC_es_msg_disassemble_mtu_below_minimum(void **state)
{
    iot_error_t err;
...
void TC_es_msg_disassemble_continued_keeps_cmd(void **state)
{
    iot_error_t err;
    uint8_t payload[8] = {0};
    uint8_t buf[32];
...
void TC_es_reset_transferdata_idempotent(void **state)
{
    UNUSED(state);
...
int TEST_FUNC_iot_easysetup_ble_msg(void)
{
    const struct CMUnitTest tests[] = {
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_null_buf, _tc_ble_msg_setup, _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_zero_len, _tc_ble_msg_setup, _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_segment_larger_than_total, _tc_ble_msg_setup,
                                        _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_idle_with_non_zero_opcode, _tc_ble_msg_setup,
                                        _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_single_shot_success, _tc_ble_msg_setup,
                                        _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_fragmented_success, _tc_ble_msg_setup, _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_assemble_mismatch_opcode, _tc_ble_msg_setup,
                                        _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_assemble_overflow, _tc_ble_msg_setup, _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_duplicated_cmd_num, _tc_ble_msg_setup, _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_data_continued, _tc_ble_msg_setup, _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_transaction_id_regression, _tc_ble_msg_setup,
                                        _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_zero_total_size, _tc_ble_msg_setup, _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_disassemble_state_reset, _tc_ble_msg_setup,
                                        _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_data_alloc_failure, _tc_ble_msg_setup, _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_assemble_payload_alloc_failure, _tc_ble_msg_setup,
                                        _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_disassemble_null_buf, _tc_ble_msg_setup, _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_disassemble_zero_len, _tc_ble_msg_setup, _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_disassemble_deprecated_cmd, _tc_ble_msg_setup, _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_disassemble_malloc_failure, _tc_ble_msg_setup, _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_disassemble_success_single_shot, _tc_ble_msg_setup,
                                        _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_disassemble_success_fragmented, _tc_ble_msg_setup,
                                        _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_disassemble_mtu_below_minimum, _tc_ble_msg_setup,
                                        _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_msg_disassemble_continued_keeps_cmd, _tc_ble_msg_setup,
                                        _tc_ble_msg_teardown),
        cmocka_unit_test_setup_teardown(TC_es_reset_transferdata_idempotent, _tc_ble_msg_setup, _tc_ble_msg_teardown),
    };
